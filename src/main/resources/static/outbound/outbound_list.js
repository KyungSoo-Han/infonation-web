...
function Search(){
    ...
    srchCond.bizId = "1";
    srchCond.outboundNo = document.getElementById('outboundNo').value;    // 신규 입력시 공백,
    ...
    srchCond.destinationId = document.getElementById('destinationId').value;

    $.ajax({
        method : "POST",
        url : sessionStorage.getItem("serverUrl") + "/api/outbound/list",
